...
// Client-side cosmetics catalog for display and rendering. Prices here
// MUST match purchase_cosmetic()'s server-side price lookup in SQL exactly
// — the server never trusts a client-supplied price, so this list is only
// for showing prices in the shop UI, not for enforcement. If prices ever
// change, both places need updating by hand.
const COSMETIC_CATALOG = {
  color_amber:   { category:'color', label:'Amber',   price:75,  value:'#F2C94C' },
  color_crimson: { category:'color', label:'Crimson',  price:75,  value:'#FF4444' },
  color_sage:    { category:'color', label:'Sage',     price:75,  value:'#7A9B5C' },
  color_sky:     { category:'color', label:'Sky',      price:75,  value:'#5DA9E8' },
  color_violet:  { category:'color', label:'Violet',   price:75,  value:'#B57EDC' },
  color_gold:    { category:'color', label:'Gold',     price:75,  value:'#D4AF37' },
  border_amber:   { category:'border', label:'Amber Line',    price:100, value:'2px solid #39FF14' },
  border_danger:  { category:'border', label:'Danger Stripe', price:100, value:'2px solid #FF4444' },
  border_success: { category:'border', label:'Success Line',  price:100, value:'2px solid #7A9B5C' },
  border_double:  { category:'border', label:'Double Border', price:100, value:'3px double #E4E6DC' },
  bg_amber:  { category:'background', label:'Amber Tint',  price:125, value:'rgba(57,255,20,0.08)' },
  bg_static: { category:'background', label:'Dark Static', price:125, value:'repeating-linear-gradient(45deg, #0A0C0A, #0A0C0A 4px, #14170F 4px, #14170F 8px)' },
  bg_void:   { category:'background', label:'Void Black',  price:125, value:'#050505' },
  bg_gold:   { category:'background', label:'Gold Tint',   price:125, value:'rgba(212,175,55,0.08)' },
};
